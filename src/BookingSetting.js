...
class BookingSetting extends Component {
    ...
    weekdayStr = () => {
      ...
      combine() {
          this.setState({all: this.state.weekday + " " +this.state.start + "-" + this.state.end});
      }
    ...
    render() {
        return (
            ...
            <div className="container p-2">
                ...
                <hr/>
                {this.state.weekday} {this.state.start}{this.state.start ? this.state.end ? "-" : "" : ""}{this.state.end}
                <br/>
